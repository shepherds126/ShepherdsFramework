...
namespace ShepherdsFramework.Framework.Utilities.Captcha
{
    ...
    public static class VerificationCodeRandomString
    {
        ...
        private static Dictionary<CaptchaCharacterSet, Point> InitializeRanges()
        {
            ...
            ranges[CaptchaCharacterSet.LowercaseLetters] = new Point('a', 'z');
            ranges[CaptchaCharacterSet.UppercaseLetters] = new Point('A', 'Z');
            ranges[CaptchaCharacterSet.Digits] = new Point('0', '9');
            return ranges;
        }
